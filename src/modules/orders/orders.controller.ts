...
export class OrdersController {
  ...
  async updateStatus(
    ...
    const hasAdminPermission = user.permissions?.includes('perm_manage_orders');
    return this.ordersService.updateStatus(id, updateStatusDto, user.sub, hasAdminPermission);
  }
  ...
  async addNote(
    ...
    return this.ordersService.addNote(id, addNoteDto, user.sub, user.name || 'User');
  }
