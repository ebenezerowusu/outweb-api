...
export class CreateOrderDto {
  ...
  @ApiPropertyOptional({ description: 'Delivery address', type: CreateDeliveryAddressDto })
  @IsObject()
  @ValidateNested()
...
export class CreateOrderTransactionDto {
  ...
  @ApiProperty({ description: 'Transaction type', enum: ['deposit', 'balance', 'refund', 'fee', 'tax'] })
