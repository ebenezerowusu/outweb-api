...
export const SUBSCRIPTION_PLANS: SubscriptionPlanData[] = [
  {
    id: 'plan_cashoffer',
    name: 'Cash offer',
    description: 'Subscription for accessing instant CashOffer leads and tools.',
    category: 'cashoffer',
    price: {
      currency: 'USD',
      amount: 5000, // $50.00
  ...
  },
  {
    ...
    description: 'Wholesale access for dealers to buy and sell Tesla inventory dealer-to-dealer.',
  ...
  },
  {
    ...
    description: 'Advertising plan for dealers to run featured and boosted listings.',
