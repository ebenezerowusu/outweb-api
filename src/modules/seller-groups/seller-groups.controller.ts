...
export class SellerGroupsController {
  ...
  @ApiResponse({
    status: 200,
    description: "Seller groups list retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Seller group retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 201,
    description: "Seller group created successfully",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Seller group updated successfully",
  })
  ...
  async update(
    ...
    return this.sellerGroupsService.update(
      id,
      updateSellerGroupDto,
      user.sub,
      hasAdminPermission,
  ...
  @ApiResponse({
    status: 200,
    description: "Seller group settings updated successfully",
  })
  @ApiResponse({ status: 403, description: "Insufficient permissions" })
  @ApiResponse({ status: 404, description: "Seller group not found" })
  async updateSettings(
    ...
    return this.sellerGroupsService.updateSettings(
      id,
      updateSettingsDto,
      user.sub,
      hasAdminPermission,
  ...
  @ApiResponse({
    status: 200,
    description: "Seller group members updated successfully",
  })
  @ApiResponse({ status: 403, description: "Insufficient permissions" })
  @ApiResponse({ status: 404, description: "Seller group not found" })
  async updateMembers(
    ...
    return this.sellerGroupsService.updateMembers(
      id,
      updateMembersDto,
      user.sub,
      hasAdminPermission,
  ...
  @ApiResponse({
    status: 200,
    description: "Seller group metadata updated successfully",
  })
  @ApiResponse({ status: 403, description: "Insufficient permissions" })
  @ApiResponse({ status: 404, description: "Seller group not found" })
  async updateMeta(
