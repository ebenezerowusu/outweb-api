...
export class SellerReviewsController {
  ...
  @Get()
  @ApiOperation({
    summary: "List reviews for a seller with filters and pagination",
  })
  ...
  @ApiResponse({
    status: 400,
    description: "Bad request - validation error or duplicate review",
  })
  ...
  async create(
    ...
    return this.sellerReviewsService.create(
      sellerId,
  ...
  async update(
    ...
    return this.sellerReviewsService.update(
      sellerId,
      id,
      updateSellerReviewDto,
      user.sub,
  ...
  async delete(
    ...
    await this.sellerReviewsService.delete(
      sellerId,
      id,
      user.sub,
      hasAdminPermission,
  ...
  @ApiResponse({
    status: 400,
    description: "Bad request - response already exists",
  })
  @ApiResponse({ status: 404, description: "Review not found" })
  async createResponse(
    ...
    return this.sellerReviewsService.createResponse(
      sellerId,
      id,
      createResponseDto,
      user.sub,
  ...
  @ApiResponse({
    status: 200,
    description: "Review moderation updated successfully",
  })
  ...
  async updateModeration(
    ...
    return this.sellerReviewsService.updateModeration(
      sellerId,
      id,
      updateModerationDto,
      user.sub,
